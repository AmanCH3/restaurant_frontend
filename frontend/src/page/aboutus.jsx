...
function Aboutus(){
  return (
    <div className='max-w-full'>
        ...
        <div>
            <img src={"../src/assets/aboutus/aboutus.png"} alt="Logo of the restuarnt" />
        </div>
        ...
        <div className=' bg-gallery flex flex-row m-20 gap-10 pb-20'>
            ...
            <img src={"../src/assets/aboutus/person1.png"} alt="lady" />
            ...
            <div className='flex flex-col items-center space-y-3 bg-gallery'>
                <img src={"../src/assets/aboutus/person2.png"} alt="photo of CEO" />
